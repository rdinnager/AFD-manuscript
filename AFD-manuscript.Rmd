...
These methods have been thoroughly described elsewhere [e.g. see @Cheng2013], but for the reader's benefit we provide a brief description here. (__Note:__ This will be easy but tedious (rewording pointlessy the original description). Can we get away with just quoting from the original paper? Never understooding why direct quoting seems to not be used in biology, this type of thing would be the perfect place for it.)
